...
public final class RobotMap {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = Math.toRadians(140); // competition
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = Math.toRadians(168); // competition
